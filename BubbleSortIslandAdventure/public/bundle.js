(function (lighterhtml) {
  ...
  const LEVELS = [{
    ...
    mobs: [
      ...
      {x: 2, y: 0, spritesheet: 'img-visitor', sprite: 'dog'},
      {x: 3, y: 0, spritesheet: 'img-visitor', sprite: 'chicken'},
      ...
      {x: 2, y: 2, spritesheet: 'img-visitor', sprite: 'sword'},
      // {x: 3, y: 2, spritesheet: 'img-number', sprite: 2},
      // {x: 4, y: 2, spritesheet: 'img-number', sprite: 4},

      {x: 0, y: 3, spritesheet: 'img-path', sprite: 3},
      {x: 1, y: 3, spritesheet: 'img-path', sprite: 4},
      {x: 2, y: 3, spritesheet: 'img-visitor', sprite: 'flower'},
      {x: 3, y: 3, spritesheet: 'img-visitor', sprite: 'pig'},
      {x: 4, y: 3, spritesheet: 'img-visitor', sprite: 'pig'},

      {x: 0, y: 4, spritesheet: 'img-path', sprite: 2},
      {x: 1, y: 4, spritesheet: 'img-visitor', sprite: 'chicken'},
      {x: 2, y: 4, spritesheet: 'img-visitor', sprite: 'cow'},
      {x: 3, y: 4, spritesheet: 'img-visitor', sprite: 'pig'},
      {x: 4, y: 4, spritesheet: 'img-visitor', sprite: 'dog'},
    ],
  }];
